...
## Corpus Check
- 18 files · ~392,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 219 nodes · 407 edges · 14 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03f2b05e`
...
Cohesion: 0.18
Nodes (28): $(), applyAccess(), authedFetch(), closeMyAccount(), ensureGate(), ensureMyAccountModal(), ensureTrialBanner(), fetchMe() (+20 more)
...
Cohesion: 0.06
Nodes (29): billing, billingRef, { computeAccess }, credits, D, { db }, payments, projectedNextCents (+21 more)

### Community 7 - "Community 7"
Cohesion: 0.13
Nodes (17): asaas, billing, codes, { computeAccess, TRIAL_DAYS }, D, data, { db, fieldValue, timestamp }, now (+9 more)

### Community 8 - "Community 8"
Cohesion: 0.14
Nodes (20): applyPendingCreditsTo(), asaas, billing, creditIndicatorFromIndicado(), creditsCol(), { db, fieldValue }, { db, fieldValue, timestamp }, findBillingByCustomer() (+12 more)
...
## Knowledge Gaps
- **80 isolated node(s):** `admin`, `{ auth }`, `{ db }`, `{ requireUser, cors }`, `{ computeAccess }` (+75 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `db()` connect `Community 8` to `Community 6`, `Community 7`?**
